...
export interface Specie {
    ...
    gender_rate:            number;
    genera:                 any[];
    generation:             EvolvesFromSpecies;
    growth_rate:            EvolvesFromSpecies;
    habitat:                EvolvesFromSpecies;
...
export interface Name {
    language: EvolvesFromSpecies;
    name:     string;
}

export interface PalParkEncounter {
    area:       EvolvesFromSpecies;
    base_score: number;
    rate:       number;
}
...
export interface ChainEvolutionDetails {
